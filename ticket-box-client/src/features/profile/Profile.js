...
const Profile = () => {
    ...
    const updateUser = async () => {
        if (!inforUser.email || !inforUser.name || !inforUser.birth || !inforUser.sex) {
            ...
            if (String(inforUser.email).toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/) === null) {
            ...
            <div className="form-profile">
                ...
                <span>Số điện thoại: </span>
                    <div className="phone-input">
                        <input name="phone-number" className="input-profile phone" value={inforUser.phoneNumber} disabled placeholder="Vd: 0123456789" type="text" maxLength="10" />
                    </div>
                </div>
                ...
                <div className="user-sex">
                    ...
                    <div className="wrap-radio">
                        <Radio.Group className="radio-group" onChange={onSelectSexButton} value={inforUser.sex} >
